...
/// </summary>
function RegisterGlobalHotKey(HotKeyFromTHotkey: TShortCut; GlobalAtomName: string; AppWindowHandle: HWND): Word;

/// <summary>
/// Remove global hotkey by its id and window handle
/// </summary>
